...
public class TestFreeMarker {
	...
	public void testFreemarker() throws Exception {
		...
		//3.设置模板所在的路径
		configuration.setDirectoryForTemplateLoading(new File("F:/project/com.taotao/taotao-item-web/src/main/webapp/WEB-INF/ftl"));
		//4.设置模板的字符集，一般utf-8
		...
		Writer out = new FileWriter(new File("F:/freemarkerTest/hello.html"));
	...
	@Test
	public void testFreemarkerStudent() throws Exception {
		//1.创建一个模板文件
		//2.创建一个Configuration对象
		Configuration configuration = new Configuration(Configuration.getVersion());
		//3.设置模板所在的路径
...
//		Template template = configuration.getTemplate("hello.ftl");
		...
		data.put("val","123456");
		//7.创建一个Writer对象，指定输出文件的路径及文件名。
		Writer out = new FileWriter(new File("F:/freemarkerTest/student.html"));
		//8.使用模板对象的process方法输出文件。
		template.process(data, out);
		//9.关闭流
		out.close();
